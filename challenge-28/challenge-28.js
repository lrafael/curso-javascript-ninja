  (function () {
    ...
    */
    ...
    function handleSubmitFormCEP(event) {
      ...
      $.getJSON(getUrl(), fillCEPFields);

      // let url = "https://viacep.com.br/ws/[CEP]/json/"
      //   .replace('[CEP]', $inputCEP.get()[0].value);
      // console.log(url);
      // ajax.open('GET', url);
      // ajax.send();
      // ajax.addEventListener('readystatechenage', handleReadyStateChange);
    }
    ...
    function getUrl() {
      ...
      $inputCEP.get()[0].value.replace(/\D/g, '') + "/json/?callback=?";
    }

    function fillCEPFields(data, status) {
      if (status === 'success') {
