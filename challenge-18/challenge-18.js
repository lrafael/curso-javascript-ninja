(function () {
  ...
  */
  ...
  function formatCPF(unformatedCPF) {
    let cpf = cleanCPF(unformatedCPF);
  ...
  //----------------OR-----
  function formatCPF2(unformatedCPF){
    let cpf = cleanCPF(unformatedCPF);
    return cpf.replace(/(\d{3})(\d\d\d)(\d\d\d)(\d\d)/, '$1.$2.$3-$4')
  }
  console.log(formatCPF("049-214 3421-1"));
  console.log(formatCPF2("210.458.522-05"));
