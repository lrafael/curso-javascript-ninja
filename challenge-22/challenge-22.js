  (function(window, document){
    ...
    */
    let p1 = {name: 'silvia', lastName: 'moro'};
    let p2 = {name: 'luiz', lastName: 'baroni'};
    ...
    */
    ...
    console.log(getFullName.call(p1));
    console.log(getFullName.call(p2));
    ...
    */
    ...
    function justNumbers(strOfNumbers){
      let regex = /\d+/g;
      return strOfNumbers.match(regex);
    }
