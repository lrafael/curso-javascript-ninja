(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Luiz Rafael'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'campineiro'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/, function(x){
  ...
  */
  ...
  let regexDate = /(\d\d) de (junho|julho) de (\d{4})/g;
