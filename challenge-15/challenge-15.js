(function(){
  ...
  */
  function Person(name, lastName, age) {
    ...
    this.addAge = function () {return this.age += arguments[0];};
  }
  ...
  */
  ...
  let luiz = new Person('luiz', 'baroni', 30);
  let renata = new Person('renata', 'baroni', 34);
  let silvia = new Person('silvia', 'baroni', 58);
  console.log(luiz);
  console.log(renata);
  console.log(silvia);
