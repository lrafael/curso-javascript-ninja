...
(function(){
    ...
    */
    console.log( '\nOperation:' );
    let operation = justMod2Or3.reduce(function(total, num){
        return (total +1) * num;
    });
    ...
    */
    console.log( '\nOperation 2:' );
    let operation2 = justMod2Or3.reduceRight(function(total, num){
        return (total +1) * num;
    });
    ...
    */
    ...
    let name = ['ra', 'fa', 'el'];
    let name2 = name.reduce(function(red, item){
        return red + 'p' + item;
    }, '');
    console.log(name2);
    ...
    */
    ...
    function checkObj(item, index){
        return item === {number: 2};
    };
    console.log(numberObjects.filter(checkObj) ? 
    "Existe um objeto { number: 2 } em numberObjects!" :
    "Não existe um objeto { number: 2 } em numberObjects :(");
    ...
    */
    ...
    console.log(numberObjects.lastIndexOf({number: 2}, 2) > 0 ? 
    "Existe um objeto { number: 2 } em numberObjects!" :
    "Não existe um objeto { number: 2 } em numberObjects :(");
