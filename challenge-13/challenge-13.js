(function()
{
  ...
  */
  ...
  let gt7 = brasil.every(function(item){
    return item.length > 7;
  });
  console.log(gt7 ? "Sim, todos os estados tem mais de 7 letras!" : "Nem todos os estados tem mais de 7 letras!");
  /*
  ...
  */
  let map = newBrasil.map(function(item, index){
    let newObj = {id: item.id+1, estado: item.estado + " pertence ao Brasil."};
    return newObj;
  });
